...
const Page = () => {
  return (
    <section className="mx-auto max-w-4xl grid gap-24">
      <div>
        <h1 className="text-center text-5xl sm:text-7xl !leading-tight text-transparent bg-clip-text bg-gradient-to-r from-brand-iridescent-blue to-brand-electric-purple">
